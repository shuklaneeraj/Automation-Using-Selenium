...
public class SFDC_KM_HowTos_CreateArticle_Knowledge {

	final static Logger log = LogManager.getLogger(SFDC_KM_HowTos_CreateArticle_Knowledge.class);
...
//		Robot re = new Robot();
		try {
			...
			KM_Function.howTos(SdEmID, SdPwrd, ReslnTitle);
		...
		System.out.println("HowTos Passed");

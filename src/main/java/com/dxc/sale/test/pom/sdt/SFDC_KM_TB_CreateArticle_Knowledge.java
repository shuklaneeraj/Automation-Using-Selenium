...
public class SFDC_KM_TB_CreateArticle_Knowledge {

	final static Logger log = LogManager.getLogger(SFDC_KM_TB_CreateArticle_Knowledge.class);
...
//		Robot re = new Robot();
		...
		System.out.println("KM Trouble Shooting is Passed");
